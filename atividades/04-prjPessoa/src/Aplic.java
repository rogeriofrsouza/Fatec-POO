...
public class Aplic {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ano atual: " + data.getYear());
        System.out.println("Pessoa Física");
        System.out.println("Nome: " + pf.getNome());
        System.out.println("Ano inscrição: " + pf.getAnoInscricao());
        System.out.println("CPF: " + pf.getCpf());
        System.out.println("Base: " + pf.getBase());
        System.out.println("Bônus: R$" + df.format(pf.calcBonus(data.getYear())));
        ...
        System.out.println("Bônus: R$" + df.format(pj.calcBonus(data.getYear())));
    }
}
